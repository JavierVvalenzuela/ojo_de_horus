...
export class ServicioBDService {
  ...
  tablaUsuario: string = `CREATE TABLE IF NOT EXISTS USUARIO (id_usuario INTEGER PRIMARY KEY AUTOINCREMENT, nombre_u VARCHAR(50) NOT NULL, apellido_u VARCHAR(50) NOT NULL, nick_u VARCHAR(50) NOT NULL, correo_u VARCHAR(100) NOT NULL, contrasena_u VARCHAR(50) NOT NULL, pregunta_respaldo_u VARCHAR(255), imagen_perfil_u BLOB, estado_cuenta_u CHAR(1) NOT NULL, razon_ban_u TEXT, id_rol INTEGER NOT NULL, FOREIGN KEY(id_rol) REFERENCES ROL(id_rol));`;
